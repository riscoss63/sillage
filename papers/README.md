...
LaTeX sources and figures for the four papers this repository implements.
...
A static check of all four sources: balanced braces and environments, display
...
The assistant in this repository indexes the four papers and answers with
exact passages:
